package dio.generics.lists.pesquisa;
...
public class CatalogoLivros {
    ...
    public void adicionarLivro(String titulo, String autor, int anoPuplicacao) {
        livroList.add(new Livro(titulo, autor, anoPuplicacao));
    }
